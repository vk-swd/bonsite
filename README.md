...
1. A docker
2. A file with environment variables. The file must be assigned to the "BONSITE_USER_ENV". This variable is mantioned in the [start up script](./compose.sh) and it must contain the variables described in [documentation](./documentation/docs/deployment/index.md##user-variables-with-sample-values).
